...
import es.unican.is2.transportes.negocio.CategoriaTransporte;
import es.unican.is2.transportes.negocio.Conductor;
import es.unican.is2.transportes.negocio.Transporte;
import es.unican.is2.transportes.negocio.gestionTransportes;
import fundamentos.*;
	...
	public static void main(String[] args) { //WMC+1
		...
		while(true) { //WMC+1 //CCog+1
			...
			case  ANHADE_CONDUCTOR: //WMC+1
				...
				// Anhade el conductor
				if (!gt.anhadeConductor(dni, nombre, apellido1, apellido2, direccion)) //WMC+1 //CCog+1+1+1
			...
			case MEJOR_CONDUCTOR: //WMC+1
				...
				for (Conductor conductor : gt.conductores()) { //WMC+1 //CCog+1+1+1
					if (conductor.sueldo() > maxSueldo) { //WMC+1 //CCog+1+1+1+1
